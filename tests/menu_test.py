...
async def test_patch_menu(ac: AsyncClient, menu_id: UUID4, last_menu_data):
    data = {
    "title": fake.sentence(),
    "description": fake.sentence()
    }
...
async def test_del_menu(ac: AsyncClient, db_session: AsyncSession, menu_id:UUID4):
